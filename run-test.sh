...
docker run -d -p 9999:9999 --net host -v /var/run/docker.sock:/var/run/docker.sock --name influx-v2 quay.io/influxdb/influx:nightly /entrypoint.sh influxd --e2e-testing=true
